...
- **Inclusive UI Design:**
  - **For Low Vision:** High contrast dark mode (pure white text against deep navy backgrounds) exceeding AAA contrast standards. Key data points (like Expiry Dates) utilize enlarged 15pt+ fonts, ensuring readability.
